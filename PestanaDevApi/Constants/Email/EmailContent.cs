namespace PestanaDevApi.Constants.Email
{
    public class EmailContent
    {
        ...
        #region Contact
        public const string ContactConfirmationEmailTitleEnglish = "Hello, ";
        public const string ContactConfirmationEmailParagraphEnglish = @$"Thank you for reaching out. I have received your email.<br>I will get back to you as soon as possible.";
        #endregion
        ...
        #region Contact
        public const string ContactConfirmationEmailTitlePortuguese = "Olá, ";
        public const string CopyRightPortuguese = " Pestana Dev. Todos os direitos reservados.";
        #endregion
